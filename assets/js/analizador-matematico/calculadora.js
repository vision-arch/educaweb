...
class CalculadoraCientifica {
  ...
  inicializarEventosBotones() {
    ...
    document
      ...
      .addEventListener("click", () => this.limpiarDisplay());
    document
      .getElementById("btn-borrar")
      .addEventListener("click", () => this.borrarUltimoCaracter());
    document
      .getElementById("btn-analizar")
      .addEventListener("click", () => this.analizarExpresion());
